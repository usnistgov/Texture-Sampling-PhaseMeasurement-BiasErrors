...
h_ferrite=Miller({1,1,0},{2,0,0},{2,1,1},{2,2,0},{3,1,0},{2,2,2},{3,2,1},{4,0,0},{3,3,0},{4,1,1},...
    {4,2,0},{3,3,2},{4,2,2},{4,3,1},{5,1,0}, {5,2,1},{4,4,0},{4,3,3},{5,3,0},{4,4,2},{6,0,0},{5,3,2},{6,1,1},...
    {6,2,0},{5,4,1},{6,2,2},{6,3,1},{4,4,4},{5,4,3},{5,5,0},{7,1,0},{6,4,0},{5,5,2},{6,3,3}, {5,5,4},  cs);
...
h_austenite=Miller({1,1,1},{2,0,0},{2,2,0},{3,1,1},{2,2,2},{4,0,0},{3,3,1},{4,2,0},{4,2,2},{3,3,3},{5,1,1},...
    {4,4,0},{5,3,1},{4,4,2},{6,0,0},{6,2,0},{5,3,3},{6,2,2},{4,4,4},{5,5,1},{7,1,1},{6,4,0},{6,4,2},{5,5,3},{7,3,1},...
    {8,0,0},{7,3,3},{6,4,4},{8,2,0},{6,6,0},{8,2,2},{5,5,5},{7,5,1},{6,6,2},{8,4,0}, cs);

% Create save paths (if the don't exist)
AddFiguresDir='ODFFiguresHW_2021Aug06';
MtexDataDir='MtexDataHW_2021Aug06';
mkdir(AddFiguresDir)
mkdir(MtexDataDir)
